package net.paradisu.ParadisuPlugin.playerdata;
...
public class PlayerData {
    ...
    public static void updatePlayer(Player player) {
        ...
        try(Connection conn = dataSource.getConnection(); PreparedStatement playerQuery = conn.prepareStatement("SELECT * FROM PlayerData WHERE UUID = ?")){
            ...
            if(playerResult.getString("top_rank") == null || !(playerResult.getString("top_rank").equals(PlayerDataGetter.GetPlayerTopRank(player)))){
