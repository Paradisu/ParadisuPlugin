...
with open('hatmodels.yml', encoding="utf8") as f:
...
statements = []
template = 'INSERT IGNORE INTO HatModels (id, displayname, enchantslot1, enchantslot2, enchantslot3, enchantslot1level, enchantslot2level, enchantslot3level, unbreakable, hideunbreakable, hideenchants) VALUES ({}, "{}", "{}", "{}", "{}", {}, {}, {}, {}, {}, {});'
for key in data:
...
with open('resultHats.sql', 'w', encoding="utf8") as f:
