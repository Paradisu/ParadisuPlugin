...
public class TeleportQueue {
     ...
     * @return True if the TeleportRequestHeader with the given player array is in the recent teleport queue, false otherwise
     */
     ...
     * @return The last player the input player was teleported to, null if the input player is not in the recent teleport queue
     */
     ...
     * @return The nth player in the recent teleport queue for the given TeleportRequestHeader, null if the input player is not in the recent teleport queue
     */
    public Player getPlayer(TeleportRequestHeader requestHeader, int n) {
        return teleportQueue.getIfPresent(requestHeader) == null ? null : (teleportQueue.getIfPresent(requestHeader)[n].isActive() ? teleportQueue.getIfPresent(requestHeader)[n] : null);
    }
